    ...
    <header class="header">
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="Disease Diagnosis/Disease Diagnosis.html" data-en="Disease Diagnosis" data-bn="রোগ নির্ণয়">Disease Diagnosis</a></li>
                ...
                <li><a href="loan.html" data-en="Loan Assistance" data-bn="ঋণ সহায়তা">Loan Assistance</a></li>
                <?php if (isset($_SESSION["user"])): ?>
                    <li><a class="Contact" href="logout.php" data-en="Logout" data-bn="লগআউট">Logout</a></li>
                <?php else: ?>
                    <li><a class="Contact" href="login.php" data-en="Login" data-bn="লগইন">Login</a></li>
                <?php endif; ?>
            </ul>
        </nav>
